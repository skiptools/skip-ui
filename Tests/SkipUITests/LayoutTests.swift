...
final class LayoutTests: XCSnapshotTestCase {
    ...
    func testRotatedSquareAliased() throws {
        ...
        00 00 00 00 07 BA B7 08 00 00 00 00
        00 00 00 07 BA FF FF B7 08 00 00 00
        00 00 07 BA FF FF FF FF B7 08 00 00
        00 07 BA FF FF FF FF FF FF B7 08 00
        00 08 B7 FF FF FF FF FF FF BA 07 00
        00 00 08 B7 FF FF FF FF BA 07 00 00
        00 00 00 08 B7 FF FF BA 07 00 00 00
        00 00 00 00 08 B7 BA 07 00 00 00 00
        00 00 00 00 00 08 08 00 00 00 00 00
        00 00 00 00 00 00 00 00 00 00 00 00
        """))
    }
