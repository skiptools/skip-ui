...
extension View {
    ...
    public func gesture<T>(_ gesture: T, including mask: GestureMask = .all) -> some View where T : Gesture { return stubView() }
    ...
    ///      affects other gestures recognized by the view and its subviews.
    ///      Defaults to ``SkipUI/GestureMask/all``.
    public func highPriorityGesture<T>(_ gesture: T, including mask: GestureMask = .all) -> some View where T : Gesture { return stubView() }
    ...
    ///      affects other gestures recognized by the view and its subviews.
    ///      Defaults to ``SkipUI/GestureMask/all``.
    public func simultaneousGesture<T>(_ gesture: T, including mask: GestureMask = .all) -> some View where T : Gesture { return stubView() }
