...
extension View {
    ...
    // SKIP @bridge
    public func focusedHashable(getValue: @escaping () -> Any?, setValue: @escaping (Any?) -> Void, equals value: Any?) -> any View {
        return focused(Binding(get: getValue, set: setValue), equals: value)
    }

    // SKIP @bridge
    public func focusedBool(getValue: @escaping () -> Bool, setValue: @escaping (Bool) -> Void, equals value: Bool) -> any View {
        return focused(Binding(get: getValue, set: setValue), equals: value)
    }

    public func focused(_ condition: Binding<Bool>) -> any View {
