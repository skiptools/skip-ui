...
#if !SKIP
typealias ColorImpl = SwiftUI.Color
#endif

extension View {
    /// Sets the color for this view.
    ...
    public func foregroundColor(_ color: Color) -> some View {
        ...
        #else
        return self.foregroundColor(color.colorImpl)
        #endif
    }
    ...
    public func background(_ color: Color) -> some View {
        #if SKIP
        return ComposeContextView(self) {
            $0.modifier = $0.modifier.background(color.colorImpl.composeColor())
        }
        #else
        return self.background(color.colorImpl)
        #endif
    }
}
...
public struct Color : Hashable {
    var colorImpl: ColorImpl
    
    init(color colorImpl: ColorImpl) {
...
extension Color {
    ...
    public static let red = Color(color: ColorImpl.red)

    /// A context-dependent orange color suitable for use in UI elements.
    public static let orange = Color(color: ColorImpl.orange)

    /// A context-dependent yellow color suitable for use in UI elements.
    public static let yellow = Color(color: ColorImpl.yellow)

    /// A context-dependent green color suitable for use in UI elements.
    public static let green = Color(color: ColorImpl.green)

    /// A context-dependent mint color suitable for use in UI elements.
    public static let mint = Color(color: ColorImpl.mint)

    /// A context-dependent teal color suitable for use in UI elements.
    public static let teal = Color(color: ColorImpl.teal)

    /// A context-dependent cyan color suitable for use in UI elements.
    public static let cyan = Color(color: ColorImpl.cyan)

    /// A context-dependent blue color suitable for use in UI elements.
    public static let blue = Color(color: ColorImpl.blue)

    /// A context-dependent indigo color suitable for use in UI elements.
    public static let indigo = Color(color: ColorImpl.indigo)

    /// A context-dependent purple color suitable for use in UI elements.
    public static let purple = Color(color: ColorImpl.purple)

    /// A context-dependent pink color suitable for use in UI elements.
    public static let pink = Color(color: ColorImpl.pink)

    /// A context-dependent brown color suitable for use in UI elements.
    public static let brown = Color(color: ColorImpl.brown)

    /// A white color suitable for use in UI elements.
    public static let white = Color(color: ColorImpl.white)

    /// A context-dependent gray color suitable for use in UI elements.
    public static let gray = Color(color: ColorImpl.gray)

    /// A black color suitable for use in UI elements.
    public static let black = Color(color: ColorImpl.black)

    /// A clear color suitable for use in UI elements.
    public static let clear = Color(color: ColorImpl.clear)

    /// The color to use for primary content.
    public static let primary = Color(color: ColorImpl.primary)

    /// The color to use for secondary content.
    public static let secondary = Color(color: ColorImpl.secondary)
}

#if SKIP
struct ColorImpl {
    static let clear = ColorImpl { androidx.compose.ui.graphics.Color.Transparent }
    static let black = ColorImpl { androidx.compose.ui.graphics.Color.Black }
    static let white = ColorImpl { androidx.compose.ui.graphics.Color.White }

    static let red = ColorImpl { androidx.compose.ui.graphics.Color(0xFFFC3D39) }
    static let orange = ColorImpl { androidx.compose.ui.graphics.Color(0xFFFF9F0A) }
    static let yellow = ColorImpl { androidx.compose.ui.graphics.Color(0xFFFFCC00) }
    static let green = ColorImpl { androidx.compose.ui.graphics.Color(0xFF34C759) }
    static let mint = ColorImpl { androidx.compose.ui.graphics.Color(0xFF5AC8FA) }
    static let teal = ColorImpl { androidx.compose.ui.graphics.Color(0xFF64D2FF) }
    static let cyan = ColorImpl { androidx.compose.ui.graphics.Color(0xFF00C8FF) }
    static let blue = ColorImpl { androidx.compose.ui.graphics.Color(0xFF007AFF) }
    static let indigo = ColorImpl { androidx.compose.ui.graphics.Color(0xFF5856D6) }
    static let purple = ColorImpl { androidx.compose.ui.graphics.Color(0xFFAF52DE) }
    static let pink = ColorImpl { androidx.compose.ui.graphics.Color(0xFFFF2D55) }
    static let brown = ColorImpl { androidx.compose.ui.graphics.Color(0xFFA2845E) }
    static let gray = ColorImpl { androidx.compose.ui.graphics.Color(0xFF8E8E93) }
    static let primary = ColorImpl { androidx.compose.ui.graphics.Color(0xFF007AFF) }
    static let secondary = ColorImpl { androidx.compose.ui.graphics.Color(0xFF5856D6) }

    let composeColor: @Composable () -> androidx.compose.ui.graphics.Color

    init(composeColor: @Composable () -> androidx.compose.ui.graphics.Color) {
        self.composeColor = composeColor
    }
}
#endif
